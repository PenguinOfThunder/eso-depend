...
{
    public static async Task<AddonMetadataCollection> ParseFolderAsync(string esoPath,
    ...
    private static async Task<AddonMetadata> ProcessFile(string addOnsPath, string txtfile,
